...
class TrainersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trainer" do
    assert_difference("Trainer.count") do
      post trainers_url, params: { trainer: { money: @trainer.money, name: @trainer.name, trainer_id: @trainer.trainer_id, url_image: @trainer.url_image } }
    end
  ...
  test "should update trainer" do
    patch trainer_url(@trainer), params: { trainer: { money: @trainer.money, name: @trainer.name, trainer_id: @trainer.trainer_id, url_image: @trainer.url_image } }
